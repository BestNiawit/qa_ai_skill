...
| 2 | [test-case-writer](../skills/test-case-writer/) | SRS/PRD, Module ID, mode (sit/uat), lang, format | **Test Cases** (MD/CSV) — 23 cols + Traceability Matrix + **Sizing Summary Block** | 10k/25k | 1-2 min | ทุก req มี TC, Expected วัดได้, ไม่มี PII, Sizing Summary ครบ |
